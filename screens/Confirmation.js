...
const Confirmation = ({ navigation, route }) => {
  ...
  const confirmBooking = async () => {
    // Save the selected item to the Redux store
    ...
    // Navigate to the Booking screen with the selected item
    navigation.navigate("Booking", { item: route.params.item });
  
    // Navigate to the Main screen with the selected item
    navigation.navigate("Main", { item: route.params.item });
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.infoContainer}>
        ...
        <TouchableOpacity  onPress={confirmBooking}style={styles.bookBtn}>
